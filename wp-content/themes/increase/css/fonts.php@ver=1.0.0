...
h1 a,
.logo .title {
	font:32px/36px 'Oxygen', Arial, Helvetica, sans-serif;
	font-weight:300;
	font-style:normal;
}
...
.error h2, 
#reply-title {
	font:24px/36px 'Oxygen', Arial, Helvetica, sans-serif;
	font-weight:300;
	font-style:normal;
}
...
h4 a, 
h1.widgettitle {
	font:20px/36px 'Oxygen', Arial, Helvetica, sans-serif;
	font-weight:300;
	font-style:normal;
}
...
h5 a, 
.widgettitle {
	font:18px/24px 'Oxygen', Arial, Helvetica, sans-serif;
	font-weight:300;
	font-style:normal;
}
...
.cmsms_sitemap > li ul > li > a {
	font:16px/18px 'Oxygen', Arial, Helvetica, sans-serif;
	font-weight:300;
	font-style:normal;
}
...
span.dropcap {
	font:24px/48px 'Oxygen', Arial, Helvetica, sans-serif;
	font-weight:bold;
	font-style:normal;
}
